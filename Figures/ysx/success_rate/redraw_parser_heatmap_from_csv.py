...
CSV_PATH = Path(r"parser_subcategory_success_rate.csv")
OUTPUT_PATH = Path(r"parser_subcategory_success_rate_redrawn.pdf")
TITLE = "Parser by Attack Subcategory - Injection Parsing Success Rate"
